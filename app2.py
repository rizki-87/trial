...
async def process_slide(slide, slide_index, default_font, spell, grammar_tool, decimal_places):  
    slide_issues = []  
    # Validate Spelling  
    slide_issues.extend(validate_spelling_slide(slide, slide_index + 1, spell))  
    # Validate Fonts  
...
async def process_slide_batch(batch_slides, default_font, spell, grammar_tool, decimal_places):  
    tasks = [process_slide(slide, i, default_font, spell, grammar_tool, decimal_places) for i, slide in enumerate(batch_slides)]  
