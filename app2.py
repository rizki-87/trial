...
import spacy    
import subprocess  # Impor subprocess untuk menjalankan setup.sh  
  
# Jalankan setup.sh untuk mengunduh model spaCy  
...
def validate_slide(slide, slide_index, default_font, spell, grammar_tool, decimal_places, selected_notation):          
    ...
    slide_issues.extend(validate_million_notations_with_spacy(df, selected_notation))  # Memasukkan selected_notation          
