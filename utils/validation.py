...
from utils.million_notation_validation import validate_million_notations  # Impor fungsi validasi notasi juta  
...
def validate_tables(slide, slide_index, selected_notation):  
    ...
    issues.extend(validate_million_notations(slide, slide_index, selected_notation))  
